...
if ($postId) {
    ...
    if ($json) {
        ...
        if ($post && $post['title']) {
            ...
            $image = isset($post['image_url']) ? $post['image_url'] : $image;
        }
    }
}
?>
   ...
   <script>
    ...
    async function fetchPost() {
        ...
        try {
            ...
            canonical.href = `https://www.anbumiththiran.in/test.php?id=${postId}`;
            ...
            const ogTags = {
                ...
                'og:url': `https://www.anbumiththiran.in/post.php?id=${postId}`,
                'og:type': 'article',
